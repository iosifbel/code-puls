...
router.post("/assign/:test_id/:group_id", assignmentController.assignTestToGroup);
...
router.get("/:test_id/questions/privileged", assignmentController.getQuestionsByTestWithAnswers);
